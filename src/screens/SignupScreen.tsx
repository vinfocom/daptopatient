...
type SignupScreenNavigationProp = NativeStackNavigationProp<PatientRootStackParamList, 'Signup'>;
              ...
              {step === 1 ? (
                <>
                  ...
                  <TouchableOpacity
                    ...
                    activeOpacity={0.8}
                    className={`rounded-2xl items-center justify-center py-3.5 mt-4 ${
                  ...
                  <View className="flex-row items-center gap-3 mt-4">
                    ...
                    >
                      {loading ? (
                        ...
                        <View className="flex-row items-center">
                          <Text className="text-white font-extrabold mr-2 tracking-wide text-base">
                            Sign Up
                          </Text>

...
import {
    ...
    getPatientUnreadDoctorCountsSnapshot,
...
export default function PatientHomeScreen() {
    ...
    useEffect(() => {
        return subscribePatientChatState(() => {
